...
public class CommissionServiceImpl implements CommissionService {
	...
	@Override
	public Commission getById(Integer commissionId) throws EntityNotFoundException {
        LOGGER.debug("Finding Commission by id: {}", commissionId);
        Commission commission = this.wmGenericDao.findById(commissionId);
        if (commission == null){
	...
	@Override
	public Commission update(Commission commission) throws EntityNotFoundException {
        LOGGER.debug("Updating Commission with information: {}", commission);
        this.wmGenericDao.update(commission);

        Integer commissionId = commission.getIdCommission();

        return this.wmGenericDao.findById(commissionId);
    }
    ...
    @Transactional(readOnly = true, value = "TestDB_26mayTransactionManager")
    @Override
    public Page<Commission> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all Commissions");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDB_26may for table Commission to {} format", exportType);
