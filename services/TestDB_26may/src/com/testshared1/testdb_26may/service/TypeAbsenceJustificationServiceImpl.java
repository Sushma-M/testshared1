 ...
 */
@Service("TestDB_26may.TypeAbsenceJustificationService")
public class TypeAbsenceJustificationServiceImpl implements TypeAbsenceJustificationService {
    ...
    @Autowired
    @Qualifier("TestDB_26may.TypeAbsenceJustificationDao")
	...
	@Override
	public TypeAbsenceJustification getById(Integer typeabsencejustificationId) throws EntityNotFoundException {
        LOGGER.debug("Finding TypeAbsenceJustification by id: {}", typeabsencejustificationId);
        TypeAbsenceJustification typeabsencejustification = this.wmGenericDao.findById(typeabsencejustificationId);
	...
	@Override
	public TypeAbsenceJustification update(TypeAbsenceJustification typeabsencejustification) throws EntityNotFoundException {
        LOGGER.debug("Updating TypeAbsenceJustification with information: {}", typeabsencejustification);
        this.wmGenericDao.update(typeabsencejustification);

        Integer typeabsencejustificationId = typeabsencejustification.getIdTypeAbsenceJustification();

        return this.wmGenericDao.findById(typeabsencejustificationId);
    }
    ...
    @Transactional(readOnly = true, value = "TestDB_26mayTransactionManager")
    @Override
    public Page<TypeAbsenceJustification> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all TypeAbsenceJustifications");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDB_26may for table TypeAbsenceJustification to {} format", exportType);
