 ...
 */
@Service("TestDB_26may.CompensatoryDayDebitService")
public class CompensatoryDayDebitServiceImpl implements CompensatoryDayDebitService {
    ...
    @Autowired
    @Qualifier("TestDB_26may.CompensatoryDayDebitDao")
	...
	@Override
	public CompensatoryDayDebit getById(Integer compensatorydaydebitId) throws EntityNotFoundException {
        LOGGER.debug("Finding CompensatoryDayDebit by id: {}", compensatorydaydebitId);
        CompensatoryDayDebit compensatorydaydebit = this.wmGenericDao.findById(compensatorydaydebitId);
	...
	@Override
	public CompensatoryDayDebit update(CompensatoryDayDebit compensatorydaydebit) throws EntityNotFoundException {
        LOGGER.debug("Updating CompensatoryDayDebit with information: {}", compensatorydaydebit);
        this.wmGenericDao.update(compensatorydaydebit);

        Integer compensatorydaydebitId = compensatorydaydebit.getIdTiempoCompensatorioDiaAcreditado();

        return this.wmGenericDao.findById(compensatorydaydebitId);
    }
    ...
    @Transactional(readOnly = true, value = "TestDB_26mayTransactionManager")
    @Override
    public Page<CompensatoryDayDebit> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all CompensatoryDayDebits");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDB_26may for table CompensatoryDayDebit to {} format", exportType);
