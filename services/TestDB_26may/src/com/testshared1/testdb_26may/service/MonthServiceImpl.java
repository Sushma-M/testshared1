...
public class MonthServiceImpl implements MonthService {
	...
	@Override
	public Month getById(Integer monthId) throws EntityNotFoundException {
        LOGGER.debug("Finding Month by id: {}", monthId);
        Month month = this.wmGenericDao.findById(monthId);
        if (month == null){
	...
	@Override
	public Month update(Month month) throws EntityNotFoundException {
        LOGGER.debug("Updating Month with information: {}", month);
        this.wmGenericDao.update(month);

        Integer monthId = month.getIdMonth();

        return this.wmGenericDao.findById(monthId);
    }
    ...
    @Transactional(readOnly = true, value = "TestDB_26mayTransactionManager")
    @Override
    public Page<Month> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all Months");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDB_26may for table Month to {} format", exportType);
