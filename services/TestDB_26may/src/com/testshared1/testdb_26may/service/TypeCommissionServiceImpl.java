 ...
 * @see TypeCommission
 */
@Service("TestDB_26may.TypeCommissionService")
public class TypeCommissionServiceImpl implements TypeCommissionService {
    ...
    @Autowired
    @Qualifier("TestDB_26may.TypeCommissionDao")
	...
	@Override
	public TypeCommission getById(Integer typecommissionId) throws EntityNotFoundException {
        LOGGER.debug("Finding TypeCommission by id: {}", typecommissionId);
        TypeCommission typecommission = this.wmGenericDao.findById(typecommissionId);
	...
	@Override
	public TypeCommission update(TypeCommission typecommission) throws EntityNotFoundException {
        LOGGER.debug("Updating TypeCommission with information: {}", typecommission);
        this.wmGenericDao.update(typecommission);

        Integer typecommissionId = typecommission.getIdTypeCommission();

        return this.wmGenericDao.findById(typecommissionId);
    }
    ...
    @Transactional(readOnly = true, value = "TestDB_26mayTransactionManager")
    @Override
    public Page<TypeCommission> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all TypeCommissions");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDB_26may for table TypeCommission to {} format", exportType);
