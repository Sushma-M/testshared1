 ...
 * @see PaymentCheck
 */
@Service("TestDB_26may.PaymentCheckService")
public class PaymentCheckServiceImpl implements PaymentCheckService {
    ...
    @Autowired
    @Qualifier("TestDB_26may.PaymentCheckDao")
	...
	@Override
	public PaymentCheck getById(Integer paymentcheckId) throws EntityNotFoundException {
        LOGGER.debug("Finding PaymentCheck by id: {}", paymentcheckId);
        PaymentCheck paymentcheck = this.wmGenericDao.findById(paymentcheckId);
	...
	@Override
	public PaymentCheck update(PaymentCheck paymentcheck) throws EntityNotFoundException {
        LOGGER.debug("Updating PaymentCheck with information: {}", paymentcheck);
        this.wmGenericDao.update(paymentcheck);

        Integer paymentcheckId = paymentcheck.getIdPaymentCheck();

        return this.wmGenericDao.findById(paymentcheckId);
    }
    ...
    @Transactional(readOnly = true, value = "TestDB_26mayTransactionManager")
    @Override
    public Page<PaymentCheck> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all PaymentChecks");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDB_26may for table PaymentCheck to {} format", exportType);
