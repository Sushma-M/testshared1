 ...
 * @see Table8
 */
@Service("TestDB_26may.Table8Service")
public class Table8ServiceImpl implements Table8Service {
    ...
    @Autowired
    @Qualifier("TestDB_26may.Table8Dao")
    private WMGenericDao<Table8, String> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<Table8, String> wmGenericDao) {
	...
	@Override
	public Table8 getById(String table8Id) throws EntityNotFoundException {
    ...
    @Transactional(value = "TestDB_26mayTransactionManager")
	@Override
	public Table8 delete(String table8Id) throws EntityNotFoundException {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDB_26may for table Table8 to {} format", exportType);
