 ...
 */
@Service("TestDB_26may.ApplicantToPositionService")
public class ApplicantToPositionServiceImpl implements ApplicantToPositionService {
    ...
    @Autowired
    @Qualifier("TestDB_26may.ApplicantToPositionDao")
	...
	@Override
	public ApplicantToPosition getById(Integer applicanttopositionId) throws EntityNotFoundException {
        LOGGER.debug("Finding ApplicantToPosition by id: {}", applicanttopositionId);
        ApplicantToPosition applicanttoposition = this.wmGenericDao.findById(applicanttopositionId);
	...
	@Override
	public ApplicantToPosition update(ApplicantToPosition applicanttoposition) throws EntityNotFoundException {
        LOGGER.debug("Updating ApplicantToPosition with information: {}", applicanttoposition);
        this.wmGenericDao.update(applicanttoposition);

        Integer applicanttopositionId = applicanttoposition.getIdApplicantToPosition();

        return this.wmGenericDao.findById(applicanttopositionId);
    }
    ...
    @Transactional(readOnly = true, value = "TestDB_26mayTransactionManager")
    @Override
    public Page<ApplicantToPosition> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all ApplicantToPositions");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDB_26may for table ApplicantToPosition to {} format", exportType);
