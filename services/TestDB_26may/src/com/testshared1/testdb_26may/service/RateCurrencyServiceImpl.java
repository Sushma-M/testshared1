 ...
 * @see RateCurrency
 */
@Service("TestDB_26may.RateCurrencyService")
public class RateCurrencyServiceImpl implements RateCurrencyService {
    ...
    @Autowired
    @Qualifier("TestDB_26may.RateCurrencyDao")
	...
	@Override
	public RateCurrency getById(Integer ratecurrencyId) throws EntityNotFoundException {
        LOGGER.debug("Finding RateCurrency by id: {}", ratecurrencyId);
        RateCurrency ratecurrency = this.wmGenericDao.findById(ratecurrencyId);
	...
	@Override
	public RateCurrency update(RateCurrency ratecurrency) throws EntityNotFoundException {
        LOGGER.debug("Updating RateCurrency with information: {}", ratecurrency);
        this.wmGenericDao.update(ratecurrency);

        Integer ratecurrencyId = ratecurrency.getIdRateCurrency();

        return this.wmGenericDao.findById(ratecurrencyId);
    }
	...
	public Page<RateCurrency> findAll(QueryFilter[] queryFilters, Pageable pageable) {
        LOGGER.debug("Finding all RateCurrencies");
        return this.wmGenericDao.search(queryFilters, pageable);
    }

    @Transactional(readOnly = true, value = "TestDB_26mayTransactionManager")
    @Override
    public Page<RateCurrency> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all RateCurrencies");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDB_26may for table RateCurrency to {} format", exportType);
