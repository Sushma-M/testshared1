 ...
 */
@Service("TestDB_26may.ListOvertimePayrollService")
public class ListOvertimePayrollServiceImpl implements ListOvertimePayrollService {
    ...
    @Autowired
    @Qualifier("TestDB_26may.ListOvertimePayrollDao")
	...
	@Override
	public ListOvertimePayroll getById(Integer listovertimepayrollId) throws EntityNotFoundException {
        LOGGER.debug("Finding ListOvertimePayroll by id: {}", listovertimepayrollId);
        ListOvertimePayroll listovertimepayroll = this.wmGenericDao.findById(listovertimepayrollId);
	...
	@Override
	public ListOvertimePayroll update(ListOvertimePayroll listovertimepayroll) throws EntityNotFoundException {
        LOGGER.debug("Updating ListOvertimePayroll with information: {}", listovertimepayroll);
        this.wmGenericDao.update(listovertimepayroll);

        Integer listovertimepayrollId = listovertimepayroll.getIdListOvertimePayroll();

        return this.wmGenericDao.findById(listovertimepayrollId);
    }
    ...
    @Transactional(readOnly = true, value = "TestDB_26mayTransactionManager")
    @Override
    public Page<ListOvertimePayroll> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all ListOvertimePayrolls");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDB_26may for table ListOvertimePayroll to {} format", exportType);
