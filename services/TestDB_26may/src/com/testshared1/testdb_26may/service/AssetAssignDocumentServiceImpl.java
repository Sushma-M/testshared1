 ...
 */
@Service("TestDB_26may.AssetAssignDocumentService")
public class AssetAssignDocumentServiceImpl implements AssetAssignDocumentService {
    ...
    @Autowired
    @Qualifier("TestDB_26may.AssetAssignDocumentDao")
	...
	@Override
	public AssetAssignDocument getById(Integer assetassigndocumentId) throws EntityNotFoundException {
        LOGGER.debug("Finding AssetAssignDocument by id: {}", assetassigndocumentId);
        AssetAssignDocument assetassigndocument = this.wmGenericDao.findById(assetassigndocumentId);
	...
	@Override
	public AssetAssignDocument update(AssetAssignDocument assetassigndocument) throws EntityNotFoundException {
        LOGGER.debug("Updating AssetAssignDocument with information: {}", assetassigndocument);
        this.wmGenericDao.update(assetassigndocument);

        Integer assetassigndocumentId = assetassigndocument.getIdAssetAssignDocument();

        return this.wmGenericDao.findById(assetassigndocumentId);
    }
    ...
    @Transactional(readOnly = true, value = "TestDB_26mayTransactionManager")
    @Override
    public Page<AssetAssignDocument> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all AssetAssignDocuments");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDB_26may for table AssetAssignDocument to {} format", exportType);
