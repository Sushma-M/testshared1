...
public class TimeSheetServiceImpl implements TimeSheetService {
	...
	@Override
	public TimeSheet getById(Integer timesheetId) throws EntityNotFoundException {
        LOGGER.debug("Finding TimeSheet by id: {}", timesheetId);
        TimeSheet timesheet = this.wmGenericDao.findById(timesheetId);
        if (timesheet == null){
	...
	@Override
	public TimeSheet update(TimeSheet timesheet) throws EntityNotFoundException {
        LOGGER.debug("Updating TimeSheet with information: {}", timesheet);
        this.wmGenericDao.update(timesheet);

        Integer timesheetId = timesheet.getIdTimeSheet();
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDB_26may for table TimeSheet to {} format", exportType);
