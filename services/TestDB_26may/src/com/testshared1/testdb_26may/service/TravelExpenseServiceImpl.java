 ...
 * @see TravelExpense
 */
@Service("TestDB_26may.TravelExpenseService")
public class TravelExpenseServiceImpl implements TravelExpenseService {
    ...
    @Autowired
    @Qualifier("TestDB_26may.TravelExpenseDao")
	...
	@Override
	public TravelExpense getById(Integer travelexpenseId) throws EntityNotFoundException {
        LOGGER.debug("Finding TravelExpense by id: {}", travelexpenseId);
        TravelExpense travelexpense = this.wmGenericDao.findById(travelexpenseId);
	...
	@Override
	public TravelExpense update(TravelExpense travelexpense) throws EntityNotFoundException {
        LOGGER.debug("Updating TravelExpense with information: {}", travelexpense);
        this.wmGenericDao.update(travelexpense);

        Integer travelexpenseId = travelexpense.getIdTravelExpense();

        return this.wmGenericDao.findById(travelexpenseId);
    }
    ...
    @Transactional(readOnly = true, value = "TestDB_26mayTransactionManager")
    @Override
    public Page<TravelExpense> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all TravelExpenses");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDB_26may for table TravelExpense to {} format", exportType);
