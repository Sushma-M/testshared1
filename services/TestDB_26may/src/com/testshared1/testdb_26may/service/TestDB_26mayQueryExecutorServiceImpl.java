...
@Service
public class TestDB_26mayQueryExecutorServiceImpl implements TestDB_26mayQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(TestDB_26mayQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("TestDB_26mayWMQueryExecutor")
