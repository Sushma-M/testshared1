 ...
 * @see BadgeEmployee
 */
@Service("TestDB_26may.BadgeEmployeeService")
public class BadgeEmployeeServiceImpl implements BadgeEmployeeService {
    ...
    @Autowired
    @Qualifier("TestDB_26may.BadgeEmployeeDao")
	...
	@Override
	public BadgeEmployee getById(Integer badgeemployeeId) throws EntityNotFoundException {
        LOGGER.debug("Finding BadgeEmployee by id: {}", badgeemployeeId);
        BadgeEmployee badgeemployee = this.wmGenericDao.findById(badgeemployeeId);
	...
	@Override
	public BadgeEmployee update(BadgeEmployee badgeemployee) throws EntityNotFoundException {
        LOGGER.debug("Updating BadgeEmployee with information: {}", badgeemployee);
        this.wmGenericDao.update(badgeemployee);

        Integer badgeemployeeId = badgeemployee.getIdBadgeEmployee();

        return this.wmGenericDao.findById(badgeemployeeId);
    }
    ...
    @Transactional(readOnly = true, value = "TestDB_26mayTransactionManager")
    @Override
    public Page<BadgeEmployee> findAll(String query, Pageable pageable) {
        LOGGER.debug("Finding all BadgeEmployees");
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service TestDB_26may for table BadgeEmployee to {} format", exportType);
