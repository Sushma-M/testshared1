...
@Api(value = "/TestDB_26may/EmployeeWorkProof", description = "Exposes APIs to work with EmployeeWorkProof resource.")
...
public class EmployeeWorkProofController {
    ...
    public EmployeeWorkProof editEmployeeWorkProof(@PathVariable("id") Integer id, @RequestBody EmployeeWorkProof employeeworkproof) throws EntityNotFoundException {
