...
@Api(description = "Exposes APIs to work with EmployeeEducation resource.", value = "EmployeeEducationController")
public class EmployeeEducationController {
    ...
    public EmployeeEducation getEmployeeEducation(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public EmployeeEducation editEmployeeEducation(@PathVariable(value = "id") Integer id, @RequestBody EmployeeEducation employeeeducation) throws EntityNotFoundException {
    ...
    public boolean deleteEmployeeEducation(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
