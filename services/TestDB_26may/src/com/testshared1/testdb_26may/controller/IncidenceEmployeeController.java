...
@Api(description = "Exposes APIs to work with IncidenceEmployee resource.", value = "IncidenceEmployeeController")
public class IncidenceEmployeeController {
    ...
    public IncidenceEmployee getIncidenceEmployee(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public IncidenceEmployee editIncidenceEmployee(@PathVariable(value = "id") Integer id, @RequestBody IncidenceEmployee incidenceemployee) throws EntityNotFoundException {
    ...
    public boolean deleteIncidenceEmployee(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
