...
@Api(value = "/TestDB_26may/ListAssetReintegrated", description = "Exposes APIs to work with ListAssetReintegrated resource.")
...
public class ListAssetReintegratedController {
    ...
    public ListAssetReintegrated editListAssetReintegrated(@PathVariable("id") Integer id, @RequestBody ListAssetReintegrated listassetreintegrated) throws EntityNotFoundException {
