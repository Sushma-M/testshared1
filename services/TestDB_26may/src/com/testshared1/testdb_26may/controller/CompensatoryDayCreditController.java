...
@Api(value = "/TestDB_26may/CompensatoryDayCredit", description = "Exposes APIs to work with CompensatoryDayCredit resource.")
...
public class CompensatoryDayCreditController {
    ...
    public CompensatoryDayCredit editCompensatoryDayCredit(@PathVariable("id") Integer id, @RequestBody CompensatoryDayCredit compensatorydaycredit) throws EntityNotFoundException {
