...
@Api(value = "/TestDB_26may/EmployeeLaborHistory", description = "Exposes APIs to work with EmployeeLaborHistory resource.")
...
public class EmployeeLaborHistoryController {
    ...
    public EmployeeLaborHistory editEmployeeLaborHistory(@PathVariable("id") Integer id, @RequestBody EmployeeLaborHistory employeelaborhistory) throws EntityNotFoundException {
