...
@Api(description = "Exposes APIs to work with TypeAlert resource.", value = "TypeAlertController")
public class TypeAlertController {
    ...
    public TypeAlert getTypeAlert(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public TypeAlert editTypeAlert(@PathVariable(value = "id") Integer id, @RequestBody TypeAlert typealert) throws EntityNotFoundException {
    ...
    public boolean deleteTypeAlert(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
