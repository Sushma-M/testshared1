...
@Api(description = "Exposes APIs to work with EmployeeFile resource.", value = "EmployeeFileController")
public class EmployeeFileController {
    ...
    public EmployeeFile getEmployeeFile(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public EmployeeFile editEmployeeFile(@PathVariable(value = "id") Integer id, @RequestBody EmployeeFile employeefile) throws EntityNotFoundException {
    ...
    public boolean deleteEmployeeFile(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
