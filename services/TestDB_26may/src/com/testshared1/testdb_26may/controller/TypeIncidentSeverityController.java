...
@Api(description = "Exposes APIs to work with TypeIncidentSeverity resource.", value = "TypeIncidentSeverityController")
public class TypeIncidentSeverityController {
    ...
    public TypeIncidentSeverity getTypeIncidentSeverity(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public TypeIncidentSeverity editTypeIncidentSeverity(@PathVariable(value = "id") Integer id, @RequestBody TypeIncidentSeverity typeincidentseverity) throws EntityNotFoundException {
    ...
    public boolean deleteTypeIncidentSeverity(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
