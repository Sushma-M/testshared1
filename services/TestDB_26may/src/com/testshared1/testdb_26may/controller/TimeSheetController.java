...
@Api(value = "/TestDB_26may/TimeSheet", description = "Exposes APIs to work with TimeSheet resource.")
...
public class TimeSheetController {
    ...
    public TimeSheet editTimeSheet(@PathVariable("id") Integer id, @RequestBody TimeSheet timesheet) throws EntityNotFoundException {
