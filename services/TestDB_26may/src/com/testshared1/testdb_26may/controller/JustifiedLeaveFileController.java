...
@Api(description = "Exposes APIs to work with JustifiedLeaveFile resource.", value = "JustifiedLeaveFileController")
public class JustifiedLeaveFileController {
    ...
    public JustifiedLeaveFile getJustifiedLeaveFile(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public JustifiedLeaveFile editJustifiedLeaveFile(@PathVariable(value = "id") Integer id, @RequestBody JustifiedLeaveFile justifiedleavefile) throws EntityNotFoundException {
    ...
    public boolean deleteJustifiedLeaveFile(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
