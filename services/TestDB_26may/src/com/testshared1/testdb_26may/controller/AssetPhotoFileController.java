...
@Api(description = "Exposes APIs to work with AssetPhotoFile resource.", value = "AssetPhotoFileController")
public class AssetPhotoFileController {
    ...
    public AssetPhotoFile getAssetPhotoFile(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public AssetPhotoFile editAssetPhotoFile(@PathVariable(value = "id") Integer id, @RequestBody AssetPhotoFile assetphotofile) throws EntityNotFoundException {
    ...
    public boolean deleteAssetPhotoFile(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
