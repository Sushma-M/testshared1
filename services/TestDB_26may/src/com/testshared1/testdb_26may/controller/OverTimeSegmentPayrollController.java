...
@Api(value = "/TestDB_26may/OverTimeSegmentPayroll", description = "Exposes APIs to work with OverTimeSegmentPayroll resource.")
...
public class OverTimeSegmentPayrollController {
    ...
    public OverTimeSegmentPayroll editOverTimeSegmentPayroll(@PathVariable("id") Integer id, @RequestBody OverTimeSegmentPayroll overtimesegmentpayroll) throws EntityNotFoundException {
