...
@Api(value = "/TestDB_26may/VacationDayCredit", description = "Exposes APIs to work with VacationDayCredit resource.")
...
public class VacationDayCreditController {
    ...
    public VacationDayCredit editVacationDayCredit(@PathVariable("id") Integer id, @RequestBody VacationDayCredit vacationdaycredit) throws EntityNotFoundException {
