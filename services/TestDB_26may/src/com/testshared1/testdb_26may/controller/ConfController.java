...
@Api(value = "/TestDB_26may/Conf", description = "Exposes APIs to work with Conf resource.")
...
public class ConfController {
    ...
    public Conf editConf(@PathVariable("id") Integer id, @RequestBody Conf conf) throws EntityNotFoundException {
