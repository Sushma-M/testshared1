...
@Api(value = "/TestDB_26may/TypeMaritalStatus", description = "Exposes APIs to work with TypeMaritalStatus resource.")
...
public class TypeMaritalStatusController {
    ...
    public TypeMaritalStatus editTypeMaritalStatus(@PathVariable("id") Integer id, @RequestBody TypeMaritalStatus typemaritalstatus) throws EntityNotFoundException {
