...
@Api(description = "Exposes APIs to work with Month resource.", value = "MonthController")
public class MonthController {
    ...
    public Month getMonth(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public Month editMonth(@PathVariable(value = "id") Integer id, @RequestBody Month month) throws EntityNotFoundException {
    ...
    public boolean deleteMonth(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
