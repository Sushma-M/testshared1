...
@Api(value = "/TestDB_26may/ListCommissionEmployee", description = "Exposes APIs to work with ListCommissionEmployee resource.")
...
public class ListCommissionEmployeeController {
    ...
    public ListCommissionEmployee editListCommissionEmployee(@PathVariable("id") Integer id, @RequestBody ListCommissionEmployee listcommissionemployee) throws EntityNotFoundException {
