...
@Api(value = "/TestDB_26may/RateCurrency", description = "Exposes APIs to work with RateCurrency resource.")
...
public class RateCurrencyController {
    ...
    public RateCurrency editRateCurrency(@PathVariable("id") Integer id, @RequestBody RateCurrency ratecurrency) throws EntityNotFoundException {
