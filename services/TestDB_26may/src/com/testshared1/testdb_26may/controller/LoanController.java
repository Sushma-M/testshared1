...
@Api(value = "/TestDB_26may/Loan", description = "Exposes APIs to work with Loan resource.")
...
public class LoanController {
    ...
    public Loan editLoan(@PathVariable("id") Integer id, @RequestBody Loan loan) throws EntityNotFoundException {
