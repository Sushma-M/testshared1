...
@Api(value = "/TestDB_26may/AssetDiscardDocument", description = "Exposes APIs to work with AssetDiscardDocument resource.")
...
public class AssetDiscardDocumentController {
    ...
    public AssetDiscardDocument editAssetDiscardDocument(@PathVariable("id") Integer id, @RequestBody AssetDiscardDocument assetdiscarddocument) throws EntityNotFoundException {
