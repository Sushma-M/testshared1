...
@Api(description = "Exposes APIs to work with TravelExpense resource.", value = "TravelExpenseController")
public class TravelExpenseController {
    ...
    public TravelExpense getTravelExpense(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public TravelExpense editTravelExpense(@PathVariable(value = "id") Integer id, @RequestBody TravelExpense travelexpense) throws EntityNotFoundException {
    ...
    public boolean deleteTravelExpense(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
