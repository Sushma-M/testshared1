...
@Api(value = "/TestDB_26may/AssessmentField", description = "Exposes APIs to work with AssessmentField resource.")
...
public class AssessmentFieldController {
    ...
    public AssessmentField editAssessmentField(@PathVariable("id") Integer id, @RequestBody AssessmentField assessmentfield) throws EntityNotFoundException {
