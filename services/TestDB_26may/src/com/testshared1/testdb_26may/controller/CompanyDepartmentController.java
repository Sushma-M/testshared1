...
@Api(value = "/TestDB_26may/CompanyDepartment", description = "Exposes APIs to work with CompanyDepartment resource.")
...
public class CompanyDepartmentController {
    ...
    public CompanyDepartment editCompanyDepartment(@PathVariable("id") Integer id, @RequestBody CompanyDepartment companydepartment) throws EntityNotFoundException {
    ...
    @ApiOperation(value = "Gets the workPositions instance associated with the given id.")
     public Page<WorkPosition>
        findAssociatedWorkPositions(Pageable pageable, @PathVariable("id") Integer id) {
    ...
    @ApiOperation(value = "Gets the companyDepartmentsForFkSuperiorDepartment instance associated with the given id.")
     public Page<CompanyDepartment>
        findAssociatedCompanyDepartmentsForFkSuperiorDepartment(Pageable pageable, @PathVariable("id") Integer id) {
