...
@Api(description = "Exposes APIs to work with TypeEmployeeStatus resource.", value = "TypeEmployeeStatusController")
public class TypeEmployeeStatusController {
    ...
    public TypeEmployeeStatus getTypeEmployeeStatus(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public TypeEmployeeStatus editTypeEmployeeStatus(@PathVariable(value = "id") Integer id, @RequestBody TypeEmployeeStatus typeemployeestatus) throws EntityNotFoundException {
    ...
    public boolean deleteTypeEmployeeStatus(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
