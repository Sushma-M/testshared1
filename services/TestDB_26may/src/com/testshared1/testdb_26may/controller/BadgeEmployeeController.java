...
@Api(description = "Exposes APIs to work with BadgeEmployee resource.", value = "BadgeEmployeeController")
public class BadgeEmployeeController {
    ...
    public BadgeEmployee getBadgeEmployee(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public BadgeEmployee editBadgeEmployee(@PathVariable(value = "id") Integer id, @RequestBody BadgeEmployee badgeemployee) throws EntityNotFoundException {
    ...
    public boolean deleteBadgeEmployee(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
