...
@Api(description = "Exposes APIs to work with ListLoanDetailPayroll resource.", value = "ListLoanDetailPayrollController")
public class ListLoanDetailPayrollController {
    ...
    public ListLoanDetailPayroll getListLoanDetailPayroll(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public ListLoanDetailPayroll editListLoanDetailPayroll(@PathVariable(value = "id") Integer id, @RequestBody ListLoanDetailPayroll listloandetailpayroll) throws EntityNotFoundException {
    ...
    public boolean deleteListLoanDetailPayroll(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
