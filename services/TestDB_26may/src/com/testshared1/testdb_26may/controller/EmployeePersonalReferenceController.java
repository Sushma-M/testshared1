...
@Api(description = "Exposes APIs to work with EmployeePersonalReference resource.", value = "EmployeePersonalReferenceController")
public class EmployeePersonalReferenceController {
    ...
    public EmployeePersonalReference getEmployeePersonalReference(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public EmployeePersonalReference editEmployeePersonalReference(@PathVariable(value = "id") Integer id, @RequestBody EmployeePersonalReference employeepersonalreference) throws EntityNotFoundException {
    ...
    public boolean deleteEmployeePersonalReference(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
