...
@Api(value = "/TestDB_26may/ApplicantToPosition", description = "Exposes APIs to work with ApplicantToPosition resource.")
...
public class ApplicantToPositionController {
    ...
    public ApplicantToPosition editApplicantToPosition(@PathVariable("id") Integer id, @RequestBody ApplicantToPosition applicanttoposition) throws EntityNotFoundException {
    ...
    @ApiOperation(value = "Gets the workPositionVacantsForFkAspiranteAsignado instance associated with the given id.")
     public Page<WorkPositionVacant>
        findAssociatedWorkPositionVacantsForFkAspiranteAsignado(Pageable pageable, @PathVariable("id") Integer id) {
    ...
    @ApiOperation(value = "Gets the applicantFiles instance associated with the given id.")
     public Page<ApplicantFile>
        findAssociatedApplicantFiles(Pageable pageable, @PathVariable("id") Integer id) {
    ...
    @ApiOperation(value = "Gets the applicantAppointments instance associated with the given id.")
     public Page<ApplicantAppointment>
        findAssociatedApplicantAppointments(Pageable pageable, @PathVariable("id") Integer id) {
