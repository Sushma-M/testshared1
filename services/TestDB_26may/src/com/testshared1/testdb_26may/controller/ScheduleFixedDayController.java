...
@Api(description = "Exposes APIs to work with ScheduleFixedDay resource.", value = "ScheduleFixedDayController")
public class ScheduleFixedDayController {
    ...
    public ScheduleFixedDay getScheduleFixedDay(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public ScheduleFixedDay editScheduleFixedDay(@PathVariable(value = "id") Integer id, @RequestBody ScheduleFixedDay schedulefixedday) throws EntityNotFoundException {
    ...
    public boolean deleteScheduleFixedDay(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
