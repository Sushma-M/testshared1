...
@Api(description = "Exposes APIs to work with DeductionPeriodic resource.", value = "DeductionPeriodicController")
public class DeductionPeriodicController {
    ...
    public DeductionPeriodic getDeductionPeriodic(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public DeductionPeriodic editDeductionPeriodic(@PathVariable(value = "id") Integer id, @RequestBody DeductionPeriodic deductionperiodic) throws EntityNotFoundException {
    ...
    public boolean deleteDeductionPeriodic(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
