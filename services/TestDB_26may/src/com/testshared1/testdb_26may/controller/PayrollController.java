...
@Api(description = "Exposes APIs to work with Payroll resource.", value = "PayrollController")
public class PayrollController {
    ...
    public Payroll getPayroll(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public Payroll editPayroll(@PathVariable(value = "id") Integer id, @RequestBody Payroll payroll) throws EntityNotFoundException {
    ...
    public boolean deletePayroll(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
