...
@Api(description = "Exposes APIs to work with EmployeeMessage resource.", value = "EmployeeMessageController")
public class EmployeeMessageController {
    ...
    public EmployeeMessage getEmployeeMessage(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public EmployeeMessage editEmployeeMessage(@PathVariable(value = "id") Integer id, @RequestBody EmployeeMessage employeemessage) throws EntityNotFoundException {
    ...
    public boolean deleteEmployeeMessage(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
