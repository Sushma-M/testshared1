...
@Api(description = "Exposes APIs to work with TypeOperationTimesheet resource.", value = "TypeOperationTimesheetController")
public class TypeOperationTimesheetController {
    ...
    public TypeOperationTimesheet getTypeOperationTimesheet(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public TypeOperationTimesheet editTypeOperationTimesheet(@PathVariable(value = "id") Integer id, @RequestBody TypeOperationTimesheet typeoperationtimesheet) throws EntityNotFoundException {
    ...
    public boolean deleteTypeOperationTimesheet(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
