...
@Api(description = "Exposes APIs to work with IsrDetail resource.", value = "IsrDetailController")
public class IsrDetailController {
    ...
    public IsrDetail getIsrDetail(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public IsrDetail editIsrDetail(@PathVariable(value = "id") Integer id, @RequestBody IsrDetail isrdetail) throws EntityNotFoundException {
    ...
    public boolean deleteIsrDetail(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
