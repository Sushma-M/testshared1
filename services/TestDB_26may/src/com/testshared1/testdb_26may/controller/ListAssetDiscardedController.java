...
@Api(value = "/TestDB_26may/ListAssetDiscarded", description = "Exposes APIs to work with ListAssetDiscarded resource.")
...
public class ListAssetDiscardedController {
    ...
    public ListAssetDiscarded editListAssetDiscarded(@PathVariable("id") Integer id, @RequestBody ListAssetDiscarded listassetdiscarded) throws EntityNotFoundException {
