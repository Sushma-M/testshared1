...
@Api(value = "/TestDB_26may/TypeEmployeePayment", description = "Exposes APIs to work with TypeEmployeePayment resource.")
...
public class TypeEmployeePaymentController {
    ...
    public TypeEmployeePayment editTypeEmployeePayment(@PathVariable("id") Integer id, @RequestBody TypeEmployeePayment typeemployeepayment) throws EntityNotFoundException {
