...
@Api(value = "/TestDB_26may/RolePermission", description = "Exposes APIs to work with RolePermission resource.")
...
public class RolePermissionController {
    ...
    public RolePermission editRolePermission(@PathVariable("id") Integer id, @RequestBody RolePermission rolepermission) throws EntityNotFoundException {
    ...
    @ApiOperation(value = "Gets the listRolePermissions instance associated with the given id.")
     public Page<ListRolePermission>
        findAssociatedListRolePermissions(Pageable pageable, @PathVariable("id") Integer id) {
