...
@Api(value = "/TestDB_26may/AssetDischargeDocument", description = "Exposes APIs to work with AssetDischargeDocument resource.")
...
public class AssetDischargeDocumentController {
    ...
    public AssetDischargeDocument editAssetDischargeDocument(@PathVariable("id") Integer id, @RequestBody AssetDischargeDocument assetdischargedocument) throws EntityNotFoundException {
