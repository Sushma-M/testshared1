...
@Api(value = "/TestDB_26may/PaymentLoanManual", description = "Exposes APIs to work with PaymentLoanManual resource.")
...
public class PaymentLoanManualController {
    ...
    public PaymentLoanManual editPaymentLoanManual(@PathVariable("id") Integer id, @RequestBody PaymentLoanManual paymentloanmanual) throws EntityNotFoundException {
