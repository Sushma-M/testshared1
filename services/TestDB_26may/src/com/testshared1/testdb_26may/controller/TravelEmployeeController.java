...
@Api(description = "Exposes APIs to work with TravelEmployee resource.", value = "TravelEmployeeController")
public class TravelEmployeeController {
    ...
    public TravelEmployee getTravelEmployee(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public TravelEmployee editTravelEmployee(@PathVariable(value = "id") Integer id, @RequestBody TravelEmployee travelemployee) throws EntityNotFoundException {
    ...
    public boolean deleteTravelEmployee(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
