...
@Api(value = "/TestDB_26may/TypeExtraHourSegment", description = "Exposes APIs to work with TypeExtraHourSegment resource.")
...
public class TypeExtraHourSegmentController {
    ...
    public TypeExtraHourSegment editTypeExtraHourSegment(@PathVariable("id") Integer id, @RequestBody TypeExtraHourSegment typeextrahoursegment) throws EntityNotFoundException {
