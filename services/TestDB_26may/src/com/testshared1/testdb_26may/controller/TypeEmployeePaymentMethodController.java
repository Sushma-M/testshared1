...
@Api(description = "Exposes APIs to work with TypeEmployeePaymentMethod resource.", value = "TypeEmployeePaymentMethodController")
public class TypeEmployeePaymentMethodController {
    ...
    public TypeEmployeePaymentMethod getTypeEmployeePaymentMethod(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public TypeEmployeePaymentMethod editTypeEmployeePaymentMethod(@PathVariable(value = "id") Integer id, @RequestBody TypeEmployeePaymentMethod typeemployeepaymentmethod) throws EntityNotFoundException {
    ...
    public boolean deleteTypeEmployeePaymentMethod(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
