...
@Api(value = "/TestDB_26may/BadgeTemplate", description = "Exposes APIs to work with BadgeTemplate resource.")
...
public class BadgeTemplateController {
    ...
    public BadgeTemplate editBadgeTemplate(@PathVariable("id") Integer id, @RequestBody BadgeTemplate badgetemplate) throws EntityNotFoundException {
