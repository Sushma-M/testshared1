...
@Api(value = "/TestDB_26may/TypeAbsenceJustification", description = "Exposes APIs to work with TypeAbsenceJustification resource.")
...
public class TypeAbsenceJustificationController {
    ...
    public TypeAbsenceJustification editTypeAbsenceJustification(@PathVariable("id") Integer id, @RequestBody TypeAbsenceJustification typeabsencejustification) throws EntityNotFoundException {
