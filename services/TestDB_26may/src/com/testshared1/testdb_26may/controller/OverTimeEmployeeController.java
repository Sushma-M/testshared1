...
@Api(value = "/TestDB_26may/OverTimeEmployee", description = "Exposes APIs to work with OverTimeEmployee resource.")
...
public class OverTimeEmployeeController {
    ...
    public OverTimeEmployee editOverTimeEmployee(@PathVariable("id") Integer id, @RequestBody OverTimeEmployee overtimeemployee) throws EntityNotFoundException {
