...
@Api(description = "Exposes APIs to work with TypeTravellingExpense resource.", value = "TypeTravellingExpenseController")
public class TypeTravellingExpenseController {
    ...
    public TypeTravellingExpense getTypeTravellingExpense(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public TypeTravellingExpense editTypeTravellingExpense(@PathVariable(value = "id") Integer id, @RequestBody TypeTravellingExpense typetravellingexpense) throws EntityNotFoundException {
    ...
    public boolean deleteTypeTravellingExpense(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
