...
@Api(description = "Exposes APIs to work with TypeAsset resource.", value = "TypeAssetController")
public class TypeAssetController {
    ...
    public TypeAsset getTypeAsset(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public TypeAsset editTypeAsset(@PathVariable(value = "id") Integer id, @RequestBody TypeAsset typeasset) throws EntityNotFoundException {
    ...
    public boolean deleteTypeAsset(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
