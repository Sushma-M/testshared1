...
@Api(description = "Exposes APIs to work with Currency resource.", value = "CurrencyController")
public class CurrencyController {
    ...
    public Currency getCurrency(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public Currency editCurrency(@PathVariable(value = "id") Integer id, @RequestBody Currency currency) throws EntityNotFoundException {
    ...
    public boolean deleteCurrency(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
