...
@Api(description = "Exposes APIs to work with TypeRecruitment resource.", value = "TypeRecruitmentController")
public class TypeRecruitmentController {
    ...
    public TypeRecruitment getTypeRecruitment(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public TypeRecruitment editTypeRecruitment(@PathVariable(value = "id") Integer id, @RequestBody TypeRecruitment typerecruitment) throws EntityNotFoundException {
    ...
    public boolean deleteTypeRecruitment(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
