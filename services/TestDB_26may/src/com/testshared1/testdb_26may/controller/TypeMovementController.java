...
@Api(value = "/TestDB_26may/TypeMovement", description = "Exposes APIs to work with TypeMovement resource.")
...
public class TypeMovementController {
    ...
    public TypeMovement editTypeMovement(@PathVariable("id") Integer id, @RequestBody TypeMovement typemovement) throws EntityNotFoundException {
