...
public class AssessmentController {
    ...
    public Assessment editAssessment(@PathVariable(value = "id") Integer id, @RequestBody Assessment assessment) throws EntityNotFoundException {
    ...
    public boolean deleteAssessment(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
