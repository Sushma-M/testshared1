...
@Api(value = "/TestDB_26may/Announcement", description = "Exposes APIs to work with Announcement resource.")
...
public class AnnouncementController {
    ...
    public Announcement editAnnouncement(@PathVariable("id") Integer id, @RequestBody Announcement announcement) throws EntityNotFoundException {
