...
@Api(value = "/TestDB_26may/Viaje", description = "Exposes APIs to work with Viaje resource.")
...
public class ViajeController {
    ...
    public Viaje editViaje(@PathVariable("id") Integer id, @RequestBody Viaje viaje) throws EntityNotFoundException {
