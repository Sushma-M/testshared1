...
@Api(value = "/TestDB_26may/ApplicantAppointment", description = "Exposes APIs to work with ApplicantAppointment resource.")
...
public class ApplicantAppointmentController {
    ...
    public ApplicantAppointment editApplicantAppointment(@PathVariable("id") Integer id, @RequestBody ApplicantAppointment applicantappointment) throws EntityNotFoundException {
