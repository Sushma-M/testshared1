...
@Api(description = "Exposes APIs to work with TypeEmployeeTermination resource.", value = "TypeEmployeeTerminationController")
public class TypeEmployeeTerminationController {
    ...
    public TypeEmployeeTermination getTypeEmployeeTermination(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public TypeEmployeeTermination editTypeEmployeeTermination(@PathVariable(value = "id") Integer id, @RequestBody TypeEmployeeTermination typeemployeetermination) throws EntityNotFoundException {
    ...
    public boolean deleteTypeEmployeeTermination(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
