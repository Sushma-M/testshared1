...
@Api(value = "/TestDB_26may/BonusEventual", description = "Exposes APIs to work with BonusEventual resource.")
...
public class BonusEventualController {
    ...
    public BonusEventual editBonusEventual(@PathVariable("id") Integer id, @RequestBody BonusEventual bonuseventual) throws EntityNotFoundException {
