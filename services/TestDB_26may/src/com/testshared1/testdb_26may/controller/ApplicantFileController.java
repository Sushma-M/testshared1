...
@Api(description = "Exposes APIs to work with ApplicantFile resource.", value = "ApplicantFileController")
public class ApplicantFileController {
    ...
    public ApplicantFile getApplicantFile(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public ApplicantFile editApplicantFile(@PathVariable(value = "id") Integer id, @RequestBody ApplicantFile applicantfile) throws EntityNotFoundException {
    ...
    public boolean deleteApplicantFile(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
