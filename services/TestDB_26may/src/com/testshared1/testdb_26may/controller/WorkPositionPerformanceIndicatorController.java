...
@Api(description = "Exposes APIs to work with WorkPositionPerformanceIndicator resource.", value = "WorkPositionPerformanceIndicatorController")
public class WorkPositionPerformanceIndicatorController {
    ...
    public WorkPositionPerformanceIndicator getWorkPositionPerformanceIndicator(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public WorkPositionPerformanceIndicator editWorkPositionPerformanceIndicator(@PathVariable(value = "id") Integer id, @RequestBody WorkPositionPerformanceIndicator workpositionperformanceindicator) throws EntityNotFoundException {
    ...
    public boolean deleteWorkPositionPerformanceIndicator(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
