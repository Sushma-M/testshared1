...
@Api(value = "/TestDB_26may/TypeOperationLog", description = "Exposes APIs to work with TypeOperationLog resource.")
...
public class TypeOperationLogController {
    ...
    public TypeOperationLog editTypeOperationLog(@PathVariable("id") Integer id, @RequestBody TypeOperationLog typeoperationlog) throws EntityNotFoundException {
    ...
    @ApiOperation(value = "Gets the logOperations instance associated with the given id.")
     public Page<LogOperation>
        findAssociatedLogOperations(Pageable pageable, @PathVariable("id") Integer id) {
