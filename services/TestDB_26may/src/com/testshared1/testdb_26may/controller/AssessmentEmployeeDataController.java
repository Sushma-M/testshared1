...
@Api(description = "Exposes APIs to work with AssessmentEmployeeData resource.", value = "AssessmentEmployeeDataController")
public class AssessmentEmployeeDataController {
    ...
    public AssessmentEmployeeData getAssessmentEmployeeData(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public AssessmentEmployeeData editAssessmentEmployeeData(@PathVariable(value = "id") Integer id, @RequestBody AssessmentEmployeeData assessmentemployeedata) throws EntityNotFoundException {
    ...
    public boolean deleteAssessmentEmployeeData(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
