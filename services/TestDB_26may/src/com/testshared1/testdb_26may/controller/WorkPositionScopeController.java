...
@Api(value = "/TestDB_26may/WorkPositionScope", description = "Exposes APIs to work with WorkPositionScope resource.")
...
public class WorkPositionScopeController {
    ...
    public WorkPositionScope editWorkPositionScope(@PathVariable("id") Integer id, @RequestBody WorkPositionScope workpositionscope) throws EntityNotFoundException {
