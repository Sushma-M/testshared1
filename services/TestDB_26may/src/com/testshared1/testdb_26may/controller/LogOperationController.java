...
@Api(value = "/TestDB_26may/LogOperation", description = "Exposes APIs to work with LogOperation resource.")
...
public class LogOperationController {
    ...
    public LogOperation editLogOperation(@PathVariable("id") Integer id, @RequestBody LogOperation logoperation) throws EntityNotFoundException {
