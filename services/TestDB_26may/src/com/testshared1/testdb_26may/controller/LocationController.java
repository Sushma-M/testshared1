...
@Api(description = "Exposes APIs to work with Location resource.", value = "LocationController")
public class LocationController {
    ...
    public Location getLocation(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public Location editLocation(@PathVariable(value = "id") Integer id, @RequestBody Location location) throws EntityNotFoundException {
    ...
    public boolean deleteLocation(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
