...
@Api(value = "/TestDB_26may/ListPeriodicBonusPayroll", description = "Exposes APIs to work with ListPeriodicBonusPayroll resource.")
...
public class ListPeriodicBonusPayrollController {
    ...
    public ListPeriodicBonusPayroll editListPeriodicBonusPayroll(@PathVariable("id") Integer id, @RequestBody ListPeriodicBonusPayroll listperiodicbonuspayroll) throws EntityNotFoundException {
