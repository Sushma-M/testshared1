...
@Api(description = "Exposes APIs to work with ListCelphoneDetailPayroll resource.", value = "ListCelphoneDetailPayrollController")
public class ListCelphoneDetailPayrollController {
    ...
    public ListCelphoneDetailPayroll getListCelphoneDetailPayroll(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public ListCelphoneDetailPayroll editListCelphoneDetailPayroll(@PathVariable(value = "id") Integer id, @RequestBody ListCelphoneDetailPayroll listcelphonedetailpayroll) throws EntityNotFoundException {
    ...
    public boolean deleteListCelphoneDetailPayroll(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
