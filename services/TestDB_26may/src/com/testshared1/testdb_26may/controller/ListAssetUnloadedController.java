...
@Api(value = "/TestDB_26may/ListAssetUnloaded", description = "Exposes APIs to work with ListAssetUnloaded resource.")
...
public class ListAssetUnloadedController {
    ...
    public ListAssetUnloaded editListAssetUnloaded(@PathVariable("id") Integer id, @RequestBody ListAssetUnloaded listassetunloaded) throws EntityNotFoundException {
