...
@Api(value = "/TestDB_26may/PaymentCheck", description = "Exposes APIs to work with PaymentCheck resource.")
...
public class PaymentCheckController {
    ...
    public PaymentCheck editPaymentCheck(@PathVariable("id") Integer id, @RequestBody PaymentCheck paymentcheck) throws EntityNotFoundException {
