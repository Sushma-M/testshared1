...
@Api(value = "/TestDB_26may/ListEmployeePosition", description = "Exposes APIs to work with ListEmployeePosition resource.")
...
public class ListEmployeePositionController {
    ...
    public ListEmployeePosition editListEmployeePosition(@PathVariable("id") Integer id, @RequestBody ListEmployeePosition listemployeeposition) throws EntityNotFoundException {
