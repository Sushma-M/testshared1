...
@Api(value = "/TestDB_26may/Alert", description = "Exposes APIs to work with Alert resource.")
...
public class AlertController {
    ...
    public Alert editAlert(@PathVariable("id") Integer id, @RequestBody Alert alert) throws EntityNotFoundException {
