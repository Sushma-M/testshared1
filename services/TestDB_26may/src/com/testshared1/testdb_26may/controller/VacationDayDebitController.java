...
@Api(value = "/TestDB_26may/VacationDayDebit", description = "Exposes APIs to work with VacationDayDebit resource.")
...
public class VacationDayDebitController {
    ...
    public VacationDayDebit editVacationDayDebit(@PathVariable("id") Integer id, @RequestBody VacationDayDebit vacationdaydebit) throws EntityNotFoundException {
