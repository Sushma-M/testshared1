...
@Api(value = "/TestDB_26may/EmployeeSalary", description = "Exposes APIs to work with EmployeeSalary resource.")
...
public class EmployeeSalaryController {
    ...
    public EmployeeSalary editEmployeeSalary(@PathVariable("id") Integer id, @RequestBody EmployeeSalary employeesalary) throws EntityNotFoundException {
