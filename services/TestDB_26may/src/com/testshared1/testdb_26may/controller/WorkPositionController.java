...
@Api(value = "/TestDB_26may/WorkPosition", description = "Exposes APIs to work with WorkPosition resource.")
...
public class WorkPositionController {
    ...
    public WorkPosition editWorkPosition(@PathVariable("id") Integer id, @RequestBody WorkPosition workposition) throws EntityNotFoundException {
    ...
    @ApiOperation(value = "Gets the workPositionRequiements instance associated with the given id.")
     public Page<WorkPositionRequiement>
        findAssociatedWorkPositionRequiements(Pageable pageable, @PathVariable("id") Integer id) {
    ...
    @ApiOperation(value = "Gets the workPositionVacants instance associated with the given id.")
     public Page<WorkPositionVacant>
        findAssociatedWorkPositionVacants(Pageable pageable, @PathVariable("id") Integer id) {
    ...
    @ApiOperation(value = "Gets the workPositionResponsibilities instance associated with the given id.")
     public Page<WorkPositionResponsibility>
        findAssociatedWorkPositionResponsibilities(Pageable pageable, @PathVariable("id") Integer id) {
    ...
    @ApiOperation(value = "Gets the workPositionsForFkSuperiorPosition instance associated with the given id.")
     public Page<WorkPosition>
        findAssociatedWorkPositionsForFkSuperiorPosition(Pageable pageable, @PathVariable("id") Integer id) {
    ...
    @ApiOperation(value = "Gets the workPositionScopes instance associated with the given id.")
     public Page<WorkPositionScope>
        findAssociatedWorkPositionScopes(Pageable pageable, @PathVariable("id") Integer id) {
    ...
    @ApiOperation(value = "Gets the workPositionPerformanceIndicators instance associated with the given id.")
     public Page<WorkPositionPerformanceIndicator>
        findAssociatedWorkPositionPerformanceIndicators(Pageable pageable, @PathVariable("id") Integer id) {
