...
@Api(value = "/TestDB_26may/AssetAssignDocument", description = "Exposes APIs to work with AssetAssignDocument resource.")
...
public class AssetAssignDocumentController {
    ...
    public AssetAssignDocument editAssetAssignDocument(@PathVariable("id") Integer id, @RequestBody AssetAssignDocument assetassigndocument) throws EntityNotFoundException {
