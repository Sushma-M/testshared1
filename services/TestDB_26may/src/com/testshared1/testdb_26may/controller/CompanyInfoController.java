...
@Api(description = "Exposes APIs to work with CompanyInfo resource.", value = "CompanyInfoController")
public class CompanyInfoController {
    ...
    public CompanyInfo getCompanyInfo(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public CompanyInfo editCompanyInfo(@PathVariable(value = "id") Integer id, @RequestBody CompanyInfo companyinfo) throws EntityNotFoundException {
    ...
    public boolean deleteCompanyInfo(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
