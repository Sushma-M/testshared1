...
@Api(value = "/TestDB_26may/ListOvertimePayroll", description = "Exposes APIs to work with ListOvertimePayroll resource.")
...
public class ListOvertimePayrollController {
    ...
    public ListOvertimePayroll editListOvertimePayroll(@PathVariable("id") Integer id, @RequestBody ListOvertimePayroll listovertimepayroll) throws EntityNotFoundException {
