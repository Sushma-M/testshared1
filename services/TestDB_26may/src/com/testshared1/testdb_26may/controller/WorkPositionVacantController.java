...
@Api(description = "Exposes APIs to work with WorkPositionVacant resource.", value = "WorkPositionVacantController")
public class WorkPositionVacantController {
    ...
    public WorkPositionVacant getWorkPositionVacant(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public WorkPositionVacant editWorkPositionVacant(@PathVariable(value = "id") Integer id, @RequestBody WorkPositionVacant workpositionvacant) throws EntityNotFoundException {
    ...
    public boolean deleteWorkPositionVacant(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
