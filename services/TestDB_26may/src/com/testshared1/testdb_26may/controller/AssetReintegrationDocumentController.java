...
@Api(value = "/TestDB_26may/AssetReintegrationDocument", description = "Exposes APIs to work with AssetReintegrationDocument resource.")
...
public class AssetReintegrationDocumentController {
    ...
    public AssetReintegrationDocument editAssetReintegrationDocument(@PathVariable("id") Integer id, @RequestBody AssetReintegrationDocument assetreintegrationdocument) throws EntityNotFoundException {
