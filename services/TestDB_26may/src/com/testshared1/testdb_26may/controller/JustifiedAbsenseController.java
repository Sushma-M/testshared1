...
@Api(value = "/TestDB_26may/JustifiedAbsense", description = "Exposes APIs to work with JustifiedAbsense resource.")
...
public class JustifiedAbsenseController {
    ...
    public JustifiedAbsense editJustifiedAbsense(@PathVariable("id") Integer id, @RequestBody JustifiedAbsense justifiedabsense) throws EntityNotFoundException {
    ...
    @ApiOperation(value = "Gets the justifiedLeaveFiles instance associated with the given id.")
     public Page<JustifiedLeaveFile>
        findAssociatedJustifiedLeaveFiles(Pageable pageable, @PathVariable("id") Integer id) {
