...
@Api(description = "Exposes APIs to work with TypeCompanyDepartment resource.", value = "TypeCompanyDepartmentController")
public class TypeCompanyDepartmentController {
    ...
    public TypeCompanyDepartment getTypeCompanyDepartment(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public TypeCompanyDepartment editTypeCompanyDepartment(@PathVariable(value = "id") Integer id, @RequestBody TypeCompanyDepartment typecompanydepartment) throws EntityNotFoundException {
    ...
    public boolean deleteTypeCompanyDepartment(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
