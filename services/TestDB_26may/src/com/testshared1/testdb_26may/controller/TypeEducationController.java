...
@Api(value = "/TestDB_26may/TypeEducation", description = "Exposes APIs to work with TypeEducation resource.")
...
public class TypeEducationController {
    ...
    public TypeEducation editTypeEducation(@PathVariable("id") Integer id, @RequestBody TypeEducation typeeducation) throws EntityNotFoundException {
