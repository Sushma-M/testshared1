...
@Api(value = "/TestDB_26may/EmployeeWorkDay", description = "Exposes APIs to work with EmployeeWorkDay resource.")
...
public class EmployeeWorkDayController {
    ...
    public EmployeeWorkDay editEmployeeWorkDay(@PathVariable("id") Integer id, @RequestBody EmployeeWorkDay employeeworkday) throws EntityNotFoundException {
