...
@Api(description = "Exposes APIs to work with EmployeeTermination resource.", value = "EmployeeTerminationController")
public class EmployeeTerminationController {
    ...
    public EmployeeTermination getEmployeeTermination(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public EmployeeTermination editEmployeeTermination(@PathVariable(value = "id") Integer id, @RequestBody EmployeeTermination employeetermination) throws EntityNotFoundException {
    ...
    public boolean deleteEmployeeTermination(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
