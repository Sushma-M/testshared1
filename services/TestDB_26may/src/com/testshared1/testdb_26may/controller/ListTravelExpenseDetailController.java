...
@Api(value = "/TestDB_26may/ListTravelExpenseDetail", description = "Exposes APIs to work with ListTravelExpenseDetail resource.")
...
public class ListTravelExpenseDetailController {
    ...
    public ListTravelExpenseDetail editListTravelExpenseDetail(@PathVariable("id") Integer id, @RequestBody ListTravelExpenseDetail listtravelexpensedetail) throws EntityNotFoundException {
