...
@Api(value = "/TestDB_26may/RateOvertimeHour", description = "Exposes APIs to work with RateOvertimeHour resource.")
...
public class RateOvertimeHourController {
    ...
    public RateOvertimeHour editRateOvertimeHour(@PathVariable("id") Integer id, @RequestBody RateOvertimeHour rateovertimehour) throws EntityNotFoundException {
