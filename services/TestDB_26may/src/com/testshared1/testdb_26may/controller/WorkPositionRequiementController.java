...
@Api(description = "Exposes APIs to work with WorkPositionRequiement resource.", value = "WorkPositionRequiementController")
public class WorkPositionRequiementController {
    ...
    public WorkPositionRequiement getWorkPositionRequiement(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
    ...
    public WorkPositionRequiement editWorkPositionRequiement(@PathVariable(value = "id") Integer id, @RequestBody WorkPositionRequiement workpositionrequiement) throws EntityNotFoundException {
    ...
    public boolean deleteWorkPositionRequiement(@PathVariable(value = "id") Integer id) throws EntityNotFoundException {
